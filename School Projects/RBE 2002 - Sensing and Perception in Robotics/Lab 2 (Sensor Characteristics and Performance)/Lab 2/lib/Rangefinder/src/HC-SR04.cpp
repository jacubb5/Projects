 ...
 * It first checks to see if the ECHO is LOW to avoid interference.
 */
...
float multiplier = (40.0+80+120) / (2144+4552+6608); // Sum of measured centimeters over the sum of their combined microseconds
bool HC_SR04::getDistance(float& distance)
{
    ...
    // Sum of measured distances over reported pulse widths (us)
    distance = echoLength * multiplier; // Returns distance in cm
